...
import { getContentManagerById } from 'apiSdk/content-managers';
...
function ContentManagerViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Content Manager Detail View
          </Text>
          {hasAccess('content_manager', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/content-managers/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('content', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/contents/create?content_manager_id=${data?.id}`}>
                      ...
                      <Tbody>
                        {data?.content?.map((record) => (
                          ...
                          >
                            <Td>{record.video}</Td>
                            <Td>{record.photo}</Td>
                            <Td>{record.general_information}</Td>
                            <Td>
